              ...
              <div className={landingPageStyles.statsContainer}>
                {[
                  ...
                  <div className={landingPageStyles.statItem} key={idx}>
                    <div className={`bg-gradient-to-r ${stat.gradient} ${landingPageStyles.statNumber}`}>
                      {stat.value}
                    </div>
                           ...
                           <div className={landingPageStyles.featuresContainer}>
                            <div className={landingPageStyles.featuresHeader}>
                              ...
                              <p className={landingPageStyles.featuresDescription}> 
                                Everything you need Create Professional resume that stands out
                              </p>
                            </div>
                            ...
                            <div className={landingPageStyles.ctaCard}>
                              ...
                              <div className={landingPageStyles.ctaCardContent}>
                                <h2 className={landingPageStyles.ctaTitle}>
                                  Ready to Build your
                                  <span className={landingPageStyles.ctaTitleGradient}> Resume </span>
                                </h2>
                                <p className={landingPageStyles.ctaDescription}>
                                  Join thousands of professionals who landed their  jobs
                                </p>
                      ...
                      <footer className={landingPageStyles.footer}>
                        <div className={landingPageStyles.footerContainer}>
                          <p className={landingPageStyles.footerText}>
                            Crafted with
                            <span className={landingPageStyles.footerHeart}></span>
                            by{' '}
                            <a
                              href="https://www.myperfectresume.com/resume/ats-resume-checker"
                              target="_blank"
